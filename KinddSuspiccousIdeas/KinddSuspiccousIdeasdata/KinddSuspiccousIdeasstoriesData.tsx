export type KinddSuspiccousIdeasStoryAccent = {
  kinddSuspiccousAccentColor: string;
  kinddSuspiccousAccentBg: string;
  kinddSuspiccousAccentBorder: string;
};

export type KinddSuspiccousIdeasStory = {
  kinddSuspiccousStoryId: string;
  kinddSuspiccousStoryNumber: number;
  kinddSuspiccousStoryTag: string;
  kinddSuspiccousStoryTitle: string;
  kinddSuspiccousStorySummary: string;
  kinddSuspiccousStoryBody: string;
  kinddSuspiccousStoryAccent: KinddSuspiccousIdeasStoryAccent;
};

export const kinddSuspiccousIdeasStoryAccents: KinddSuspiccousIdeasStoryAccent[] =
  [
    {
      kinddSuspiccousAccentColor: '#2EB3FF',
      kinddSuspiccousAccentBg: 'rgba(46,179,255,0.08)',
      kinddSuspiccousAccentBorder: 'rgba(46,179,255,0.4)',
    },
    {
      kinddSuspiccousAccentColor: '#F7C948',
      kinddSuspiccousAccentBg: 'rgba(247,201,72,0.08)',
      kinddSuspiccousAccentBorder: 'rgba(247,201,72,0.4)',
    },
    {
      kinddSuspiccousAccentColor: '#A06BFF',
      kinddSuspiccousAccentBg: 'rgba(160,107,255,0.08)',
      kinddSuspiccousAccentBorder: 'rgba(160,107,255,0.4)',
    },
  ];

const kinddSuspiccousIdeasPickAccent = (
  kinddSuspiccousIndex: number,
): KinddSuspiccousIdeasStoryAccent =>
  kinddSuspiccousIdeasStoryAccents[
    kinddSuspiccousIndex % kinddSuspiccousIdeasStoryAccents.length
  ];

const kinddSuspiccousIdeasRawStories: Omit<
  KinddSuspiccousIdeasStory,
  'kinddSuspiccousStoryAccent'
>[] = [
  {
    kinddSuspiccousStoryId: 'S1',
    kinddSuspiccousStoryNumber: 1,
    kinddSuspiccousStoryTag: 'Odd',
    kinddSuspiccousStoryTitle: 'The Man Who Apologized to a Mailbox',
    ...
    kinddSuspiccousStoryBody: `A man in a long gray coat stopped in front of a red mailbox every morning at exactly 8:12. He would look left, look right, gently tap the mailbox twice, and whisper, "I'm sorry about yesterday." Then he would continue walking as if nothing unusual had happened.
...
Finally, one brave neighbor asked him directly. The man looked embarrassed and explained that he once bumped into the mailbox while carrying hot coffee, spilled it everywhere, and had felt oddly guilty ever since. The mailbox had survived. His dignity had not. From that day on, the neighbors no longer found him suspicious. They simply found him impressively committed to emotional closure.`,
  ...
  {
    kinddSuspiccousStoryId: 'S2',
    kinddSuspiccousStoryNumber: 2,
    kinddSuspiccousStoryTag: 'Mystery',
    kinddSuspiccousStoryTitle: 'The Sandwich That Returned Different',
    kinddSuspiccousStorySummary:
...
Still, Carla never trusted mustard again.`,
  ...
  {
    kinddSuspiccousStoryId: 'S3',
    kinddSuspiccousStoryNumber: 3,
    kinddSuspiccousStoryTag: 'Odd',
    kinddSuspiccousStoryTitle: 'The Neighbor With the Plastic Plants',
    kinddSuspiccousStorySummary:
      'Mr. Bell watered six plants on his balcony every morning. All six plants were plastic.',
    kinddSuspiccousStoryBody: `Every morning, Mr. Bell walked onto his balcony with a small blue watering can and carefully watered six plants. He moved slowly, with great seriousness, as if responsible for a rare botanical collection. The strange part was that all six plants were plastic.
...
The entire building relaxed after learning the truth. Mr. Bell was not hiding secrets in fake greenery. He was just a grandfather with excellent commitment to a joke.`,
  ...
  {
    kinddSuspiccousStoryId: 'S4',
    kinddSuspiccousStoryNumber: 4,
    kinddSuspiccousStoryTag: 'Weird',
    kinddSuspiccousStoryTitle: 'The Elevator That Judged People',
    kinddSuspiccousStorySummary:
      'The elevator in Building C refused to go to the fifth floor. Residents began treating it like a personality trait.',
    kinddSuspiccousStoryBody: `The elevator in Building C had a habit of refusing to go to the fifth floor. It went to every other floor without complaint, but when someone pressed five, the button blinked once and turned off. Residents began treating it like a personality trait.
...
A technician finally arrived and opened the control panel. Inside, he found a tiny sticky candy wrapper stuck near the fifth-floor button wiring. Every time the panel warmed up, the wrapper shifted just enough to create random signals.
...
The elevator was not haunted, judgmental, or anti-cabbage. It was being controlled by melted candy. The fifth floor residents felt relieved, though one of them still whispered "be nice" before pressing the button.`,
  ...
  {
    kinddSuspiccousStoryId: 'S5',
    kinddSuspiccousStoryNumber: 5,
    kinddSuspiccousStoryTag: 'Funny',
    kinddSuspiccousStoryTitle: 'The Overdramatic Coffee Order',
    kinddSuspiccousStorySummary:
      'Every day he ordered "one medium coffee, no sugar, no drama." Then one morning, he ordered tea.',
    kinddSuspiccousStoryBody: `At a small café, a man ordered the same drink every day: "one medium coffee, no sugar, no drama." The barista thought it was a joke, so she wrote "No Drama" on the cup. The man nodded seriously and left.
...
Nobody knew if he was joking. Nobody asked. His cup still said "No Drama," but everyone understood that drama had become part of the brand.`,
  ...
  {
    kinddSuspiccousStoryId: 'S6',
    kinddSuspiccousStoryNumber: 6,
    kinddSuspiccousStoryTag: 'Suspicious',
    kinddSuspiccousStoryTitle: 'The Dog Who Looked Guilty Too Early',
    kinddSuspiccousStorySummary:
      'Milo was already sitting in the hallway looking guilty before Nina discovered anything wrong.',
    kinddSuspiccousStoryBody: `When Nina came home, her dog Milo was already sitting in the hallway with his ears down and his eyes full of regret. This was unusual because Nina had not yet discovered anything wrong. Normally, Milo looked guilty only after she found the evidence.
...
From that day on, Nina called him "the innocent suspect." Milo still looked guilty whenever anyone opened the fridge.`,
  ...
  {
    kinddSuspiccousStoryId: 'S7',
    kinddSuspiccousStoryNumber: 7,
    kinddSuspiccousStoryTag: 'Curious',
    kinddSuspiccousStoryTitle: 'The Man Who Carried an Empty Briefcase',
    kinddSuspiccousStorySummary:
      'Every weekday he entered the bus with a polished black briefcase he never opened. Everyone developed theories.',
    kinddSuspiccousStoryBody: `Every weekday, a man entered the bus holding a polished black briefcase. He always placed it carefully on his knees and kept one hand on the lock. He never opened it. He never let it out of sight. Naturally, everyone on the bus developed theories.
...
The bus passengers respected the strategy immediately. The next week, three more people appeared with briefcases. One contained lunch. One contained knitting supplies. One contained another smaller briefcase, which nobody dared question.`,
  ...
  {
    kinddSuspiccousStoryId: 'S8',
    kinddSuspiccousStoryNumber: 8,
    kinddSuspiccousStoryTag: 'Awkward',
    kinddSuspiccousStoryTitle: 'The Group Chat Silence',
    kinddSuspiccousStorySummary:
    ...
    kinddSuspiccousStoryBody: `Liam sent a message to the group chat: "Anyone want to grab pizza tonight?" The message was seen by four people. Nobody replied.
...
The story was true. The silence was still rude, but not a conspiracy. Liam forgave them, though he created a new group chat called "Pizza Witness Protection Program" and added everyone except the pizza place.`,
  ...
  {
    kinddSuspiccousStoryId: 'S9',
    kinddSuspiccousStoryNumber: 9,
    kinddSuspiccousStoryTag: 'Strange',
    kinddSuspiccousStoryTitle: 'The Woman Who Bought One Spoon Every Friday',
    kinddSuspiccousStorySummary:
      'Every Friday she visited the same store and bought exactly one spoon. Not a set. Just one spoon.',
    kinddSuspiccousStoryBody: `Every Friday evening, a woman visited the same home goods store and bought exactly one spoon. Not a set. Not a fork. Not a knife. One spoon. She paid in cash, thanked the cashier, and left.
...
The store staff accepted this completely. By the end of the year, they had started recommending spoons based on mood. One cashier became known as the best spoon consultant in the neighborhood.`,
  ...
  {
    kinddSuspiccousStoryId: 'S10',
    kinddSuspiccousStoryNumber: 10,
    kinddSuspiccousStoryTag: 'Office',
    kinddSuspiccousStoryTitle: 'The Suspiciously Clean Desk',
    kinddSuspiccousStorySummary:
      'Mark\'s desk was always chaos. Monday morning it was perfectly clean. People panicked.',
    kinddSuspiccousStoryBody: `Everyone knew Mark's desk was chaos. Papers, cables, sticky notes, snack wrappers, three mugs, and a rubber duck wearing sunglasses lived there permanently. So when the office arrived Monday morning and found Mark's desk perfectly clean, people panicked.
...
Mark was relieved. The office was relieved. The duck returned to its sunglasses position by lunchtime. However, Mark kept one label: "Important Chaos." It felt accurate.`,
  ...
  {
    kinddSuspiccousStoryId: 'S11',
    kinddSuspiccousStoryNumber: 11,
    kinddSuspiccousStoryTag: 'Sweet',
    kinddSuspiccousStoryTitle: 'The Birthday Cake Alibi',
    kinddSuspiccousStorySummary:
    ...
    kinddSuspiccousStoryBody: `A birthday cake disappeared from the office fridge two hours before the surprise party. The cake had been decorated with blue frosting and tiny stars. Everyone denied touching it, but someone had frosting on their finger.
...
The party happened successfully, but Tyler was banned from writing dramatic notes near desserts.`,
  ...
  {
    kinddSuspiccousStoryId: 'S12',
    kinddSuspiccousStoryNumber: 12,
    kinddSuspiccousStoryTag: 'Cute',
    kinddSuspiccousStoryTitle: 'The Plant That Got Fan Mail',
    kinddSuspiccousStorySummary:
      'An office plant named Gregory began receiving sticky notes. Then someone wrote, "Meet me by the window after lunch."',
    kinddSuspiccousStoryBody: `A small office plant named Gregory began receiving sticky notes. At first, they were simple: "Nice leaves." Then they became more emotional: "You are doing your best." Eventually, someone wrote, "Gregory understands me."
...
Gregory recovered beautifully. He also received Employee of the Month, which caused mild resentment among actual employees.`,
  ...
  {
    kinddSuspiccousStoryId: 'S13',
    kinddSuspiccousStoryNumber: 13,
    kinddSuspiccousStoryTag: 'Coincidence',
    kinddSuspiccousStoryTitle: 'The Bus Stop Conspiracy',
    kinddSuspiccousStorySummary:
      'For three days, Daniel saw the same woman reading the same page of the same book. She never turned the page.',
    kinddSuspiccousStoryBody: `For three days in a row, Daniel arrived at the bus stop and saw the same woman reading the same page of the same book. She never turned the page. She never looked up. She simply stood there, reading page 47.
...
The next Monday, she was reading page 48. Daniel did not ask questions.`,
  ...
  {
    kinddSuspiccousStoryId: 'S14',
    kinddSuspiccousStoryNumber: 14,
    kinddSuspiccousStoryTag: 'Digital',
    kinddSuspiccousStoryTitle: 'The Cat Who Sent an Email',
    kinddSuspiccousStorySummary:
      'At 2:03 AM, Martin\'s boss received an email from his account containing only "hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh."',
    kinddSuspiccousStoryBody: `At 2:03 AM, Martin's boss received an email from Martin's account. The message contained only: "hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh." It was followed by one attached image of a ceiling fan.
...
The investigation took less time than expected. His cat had walked across the laptop, opened a draft, typed the message, and somehow attached a random photo from the desktop. The ceiling fan image had been saved months earlier for reasons Martin no longer remembered.
...
The cat was not punished. In fact, Martin changed his laptop password. The cat responded by sitting on the closed laptop for two hours, suggesting disagreement with the new security policy.`,
  ...
  {
    kinddSuspiccousStoryId: 'S15',
    kinddSuspiccousStoryNumber: 15,
    kinddSuspiccousStoryTag: 'Random',
    kinddSuspiccousStoryTitle: 'The Suspicious Lemon',
    kinddSuspiccousStorySummary:
      'A single lemon appeared on the hotel front desk every morning for a week. Nobody placed it there. Nobody removed it.',
    kinddSuspiccousStoryBody: `A single lemon appeared on the front desk of a hotel every morning for a week. Nobody placed it there. Nobody removed it during the day. It simply existed, bright yellow and unexplained.
...
The manager allowed Gerald to remain as unofficial lobby mascot. Reviews later praised the hotel's "unique citrus hospitality."`,
  ...
  {
    kinddSuspiccousStoryId: 'S16',
    kinddSuspiccousStoryNumber: 16,
    kinddSuspiccousStoryTag: 'Clever',
    kinddSuspiccousStoryTitle: 'The Notebook Full of Fake Passwords',
    kinddSuspiccousStorySummary:
      'Anna found her friend\'s notebook open to a page titled "Important Passwords." The passwords were all suspiciously strange.',
    kinddSuspiccousStoryBody: `During a study session, Anna noticed her friend's notebook lying open. One page contained a list titled "Important Passwords." This was alarming, because writing passwords in a notebook is already risky. But the passwords were even stranger.
...
The notebook remained on the desk. A new fake password was added: "RoommateConfession2024."`,
  ...
  {
    kinddSuspiccousStoryId: 'S17',
    kinddSuspiccousStoryNumber: 17,
    kinddSuspiccousStoryTag: 'Absurd',
    kinddSuspiccousStoryTitle: 'The Man Who Clapped for the Microwave',
    kinddSuspiccousStorySummary:
      'Alex clapped once whenever the microwave finished heating food. Not twice. Just one sharp clap.',
    kinddSuspiccousStoryBody: `In a shared apartment, everyone noticed that Alex clapped once whenever the microwave finished heating food. Not twice. Not applause. Just one sharp clap.
...
Still, after learning this, everyone started clapping for the microwave. Not because they believed it helped, but because nobody wanted to risk disrespecting the machine.`,
  ...
  {
    kinddSuspiccousStoryId: 'S18',
    kinddSuspiccousStoryNumber: 18,
    kinddSuspiccousStoryTag: 'Rainy',
    kinddSuspiccousStoryTitle: 'The Umbrella That Was Too Popular',
    kinddSuspiccousStorySummary:
      'A black umbrella appeared in the office entrance. By Thursday, at least seven people claimed it was theirs.',
    kinddSuspiccousStoryBody: `A black umbrella appeared in the office entrance during a rainy week. It had no name tag, no special design, and no obvious owner. By Thursday, at least seven people claimed it was theirs.
...
The office returned it, disappointed. For one glorious week, the umbrella had united them through shared false confidence.`,
  ...
  {
    kinddSuspiccousStoryId: 'S19',
    kinddSuspiccousStoryNumber: 19,
    kinddSuspiccousStoryTag: 'Secret',
    kinddSuspiccousStoryTitle: 'The Suspiciously Loud Whisper',
    kinddSuspiccousStorySummary:
      'Priya and Tom kept whispering in the break room. Everyone heard phrases like "hide it before Friday."',
    kinddSuspiccousStoryBody: `Two coworkers, Priya and Tom, kept whispering in the break room. Unfortunately, they were terrible at whispering. Everyone heard phrases like "don't tell anyone," "hide it before Friday," and "make sure the box is sealed."
...
The herb garden became popular immediately. The office also created a rule: no whispering about basil unless everyone is invited.`,
  ...
  {
    kinddSuspiccousStoryId: 'S20',
    kinddSuspiccousStoryNumber: 20,
    kinddSuspiccousStoryTag: 'Spooky',
    kinddSuspiccousStoryTitle: 'The Chair That Moved Overnight',
    kinddSuspiccousStorySummary:
      'Every morning the meeting room chair was turned toward the window. The cleaning team said they did not move it.',
    kinddSuspiccousStoryBody: `Every morning, the chair in the meeting room was slightly turned toward the window. The cleaning team said they did not move it. The office staff said they always pushed chairs under the table. Yet every morning, the same chair faced the window like it was waiting for someone.
...
export const kinddSuspiccousIdeasStories: KinddSuspiccousIdeasStory[] =
  kinddSuspiccousIdeasRawStories.map((kinddSuspiccousStory, kinddSuspiccousIndex) => ({
    ...kinddSuspiccousStory,
    kinddSuspiccousStoryAccent:
      kinddSuspiccousIdeasPickAccent(kinddSuspiccousIndex),
  }));
