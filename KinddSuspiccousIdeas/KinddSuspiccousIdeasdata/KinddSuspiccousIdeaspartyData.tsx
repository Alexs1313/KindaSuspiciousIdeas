export type KinddSuspiccousIdeasPartyCategoryId =
  | 'caught_red_handed'
  | 'family_drama'
  | 'awkward_stranger'
  | 'online_crime'
...
export type KinddSuspiccousIdeasPartyCategory = {
  kinddSuspiccousCategoryId: KinddSuspiccousIdeasPartyCategoryId;
  kinddSuspiccousCategoryLabel: string;
  kinddSuspiccousCategoryColor: string;
  kinddSuspiccousCategoryTextColor: string;
  kinddSuspiccousSituations: string[];
};

export const kinddSuspiccousIdeasPartyCategories: KinddSuspiccousIdeasPartyCategory[] =
  [
    {
      kinddSuspiccousCategoryId: 'caught_red_handed',
      kinddSuspiccousCategoryLabel: 'Caught Red-Handed',
      kinddSuspiccousCategoryColor: '#FF6B7A',
      kinddSuspiccousCategoryTextColor: '#1A2347',
      kinddSuspiccousSituations: [
        ...
        'During a board game, someone is caught with an extra card hidden under their leg. They claim it "fell there by accident." How would you question them?',
        ...
        'A player is caught looking at another player\'s answer during a quiz game. They say they were only checking the handwriting. How suspicious is that?',
    ...
    {
      kinddSuspiccousCategoryId: 'family_drama',
      kinddSuspiccousCategoryLabel: 'Family Drama',
      kinddSuspiccousCategoryColor: '#F7C948',
      kinddSuspiccousCategoryTextColor: '#1A2347',
      kinddSuspiccousSituations: [
    ...
    {
      kinddSuspiccousCategoryId: 'awkward_stranger',
      kinddSuspiccousCategoryLabel: 'Awkward Stranger',
      kinddSuspiccousCategoryColor: '#5BC4FF',
      kinddSuspiccousCategoryTextColor: '#1A2347',
      kinddSuspiccousSituations: [
    ...
    {
      kinddSuspiccousCategoryId: 'online_crime',
      kinddSuspiccousCategoryLabel: 'Online Crime',
      kinddSuspiccousCategoryColor: '#A06BFF',
      kinddSuspiccousCategoryTextColor: '#FFFFFF',
      kinddSuspiccousSituations: [
        ...
        'A player posts "I\'m offline today," but their status shows active every five minutes. Is it suspicious or normal?',
    ...
    {
      kinddSuspiccousCategoryId: 'pet_suspect',
      kinddSuspiccousCategoryLabel: 'Pet Suspect',
      kinddSuspiccousCategoryColor: '#4ADE80',
      kinddSuspiccousCategoryTextColor: '#1A2347',
      kinddSuspiccousSituations: [
    ...
    {
      kinddSuspiccousCategoryId: 'workplace_spy',
      kinddSuspiccousCategoryLabel: 'Workplace Spy',
      kinddSuspiccousCategoryColor: '#FF8A3D',
      kinddSuspiccousCategoryTextColor: '#1A2347',
      kinddSuspiccousSituations: [
