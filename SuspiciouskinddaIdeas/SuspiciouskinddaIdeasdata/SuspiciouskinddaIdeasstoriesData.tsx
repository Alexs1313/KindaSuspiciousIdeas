export type SuspiciouskinddaIdeasStoryAccent = {
  suspiciouskinddaAccentColor: string;
  suspiciouskinddaAccentBg: string;
  suspiciouskinddaAccentBorder: string;
};

export type SuspiciouskinddaIdeasStory = {
  suspiciouskinddaStoryId: string;
  suspiciouskinddaStoryNumber: number;
  suspiciouskinddaStoryTag: string;
  suspiciouskinddaStoryTitle: string;
  suspiciouskinddaStorySummary: string;
  suspiciouskinddaStoryBody: string;
  suspiciouskinddaStoryAccent: SuspiciouskinddaIdeasStoryAccent;
};

export const suspiciouskinddaIdeasStoryAccents: SuspiciouskinddaIdeasStoryAccent[] =
  [
    {
      suspiciouskinddaAccentColor: '#2EB3FF',
      suspiciouskinddaAccentBg: 'rgba(46,179,255,0.08)',
      suspiciouskinddaAccentBorder: 'rgba(46,179,255,0.4)',
    },
    {
      suspiciouskinddaAccentColor: '#F7C948',
      suspiciouskinddaAccentBg: 'rgba(247,201,72,0.08)',
      suspiciouskinddaAccentBorder: 'rgba(247,201,72,0.4)',
    },
    {
      suspiciouskinddaAccentColor: '#A06BFF',
      suspiciouskinddaAccentBg: 'rgba(160,107,255,0.08)',
      suspiciouskinddaAccentBorder: 'rgba(160,107,255,0.4)',
    },
  ];

const suspiciouskinddaIdeasPickAccent = (
  suspiciouskinddaIndex: number,
): SuspiciouskinddaIdeasStoryAccent =>
  suspiciouskinddaIdeasStoryAccents[
    suspiciouskinddaIndex % suspiciouskinddaIdeasStoryAccents.length
  ];

const suspiciouskinddaIdeasRawStories: Omit<
  SuspiciouskinddaIdeasStory,
  'suspiciouskinddaStoryAccent'
>[] = [
  {
    suspiciouskinddaStoryId: 'S1',
    suspiciouskinddaStoryNumber: 1,
    suspiciouskinddaStoryTag: 'Odd',
    suspiciouskinddaStoryTitle: 'The Man Who Apologized to a Mailbox',
    ...
    suspiciouskinddaStoryBody: `A man in a long gray coat stopped in front of a red mailbox every morning at exactly 8:12. He would look left, look right, gently tap the mailbox twice, and whisper, "I'm sorry about yesterday." Then he would continue walking as if nothing unusual had happened.
...
Finally, one brave neighbor asked him directly. The man looked embarrassed and explained that he once bumped into the mailbox while carrying hot coffee, spilled it everywhere, and had felt oddly guilty ever since. The mailbox had survived. His dignity had not. From that day on, the neighbors no longer found him suspicious. They simply found him impressively committed to emotional closure.`,
  ...
  {
    suspiciouskinddaStoryId: 'S2',
    suspiciouskinddaStoryNumber: 2,
    suspiciouskinddaStoryTag: 'Mystery',
    suspiciouskinddaStoryTitle: 'The Sandwich That Returned Different',
    suspiciouskinddaStorySummary:
    ...
    suspiciouskinddaStoryBody: `At 12:30, Carla placed her sandwich in the office fridge. It was turkey, cheese, cucumber, and exactly three slices of tomato. She knew this because she had prepared it with what she called "lunch architecture." At 1:05, she opened the fridge and found the sandwich still there, wrapped in the same paper, with her name written on it.
...
Still, Carla never trusted mustard again.`,
  ...
  {
    suspiciouskinddaStoryId: 'S3',
    suspiciouskinddaStoryNumber: 3,
    suspiciouskinddaStoryTag: 'Odd',
    suspiciouskinddaStoryTitle: 'The Neighbor With the Plastic Plants',
    suspiciouskinddaStorySummary:
      'Mr. Bell watered six plants on his balcony every morning. All six plants were plastic.',
    suspiciouskinddaStoryBody: `Every morning, Mr. Bell walked onto his balcony with a small blue watering can and carefully watered six plants. He moved slowly, with great seriousness, as if responsible for a rare botanical collection. The strange part was that all six plants were plastic.
...
The entire building relaxed after learning the truth. Mr. Bell was not hiding secrets in fake greenery. He was just a grandfather with excellent commitment to a joke.`,
  ...
  {
    suspiciouskinddaStoryId: 'S4',
    suspiciouskinddaStoryNumber: 4,
    suspiciouskinddaStoryTag: 'Weird',
    suspiciouskinddaStoryTitle: 'The Elevator That Judged People',
    suspiciouskinddaStorySummary:
      'The elevator in Building C refused to go to the fifth floor. Residents began treating it like a personality trait.',
    suspiciouskinddaStoryBody: `The elevator in Building C had a habit of refusing to go to the fifth floor. It went to every other floor without complaint, but when someone pressed five, the button blinked once and turned off. Residents began treating it like a personality trait.
...
The elevator was not haunted, judgmental, or anti-cabbage. It was being controlled by melted candy. The fifth floor residents felt relieved, though one of them still whispered "be nice" before pressing the button.`,
  ...
  {
    suspiciouskinddaStoryId: 'S5',
    suspiciouskinddaStoryNumber: 5,
    suspiciouskinddaStoryTag: 'Funny',
    suspiciouskinddaStoryTitle: 'The Overdramatic Coffee Order',
    suspiciouskinddaStorySummary:
      'Every day he ordered "one medium coffee, no sugar, no drama." Then one morning, he ordered tea.',
    suspiciouskinddaStoryBody: `At a small café, a man ordered the same drink every day: "one medium coffee, no sugar, no drama." The barista thought it was a joke, so she wrote "No Drama" on the cup. The man nodded seriously and left.
...
Nobody knew if he was joking. Nobody asked. His cup still said "No Drama," but everyone understood that drama had become part of the brand.`,
  ...
  {
    suspiciouskinddaStoryId: 'S6',
    suspiciouskinddaStoryNumber: 6,
    suspiciouskinddaStoryTag: 'Suspicious',
    suspiciouskinddaStoryTitle: 'The Dog Who Looked Guilty Too Early',
    suspiciouskinddaStorySummary:
      'Milo was already sitting in the hallway looking guilty before Nina discovered anything wrong.',
    suspiciouskinddaStoryBody: `When Nina came home, her dog Milo was already sitting in the hallway with his ears down and his eyes full of regret. This was unusual because Nina had not yet discovered anything wrong. Normally, Milo looked guilty only after she found the evidence.
...
From that day on, Nina called him "the innocent suspect." Milo still looked guilty whenever anyone opened the fridge.`,
  ...
  {
    suspiciouskinddaStoryId: 'S7',
    suspiciouskinddaStoryNumber: 7,
    suspiciouskinddaStoryTag: 'Curious',
    suspiciouskinddaStoryTitle: 'The Man Who Carried an Empty Briefcase',
    suspiciouskinddaStorySummary:
      'Every weekday he entered the bus with a polished black briefcase he never opened. Everyone developed theories.',
    suspiciouskinddaStoryBody: `Every weekday, a man entered the bus holding a polished black briefcase. He always placed it carefully on his knees and kept one hand on the lock. He never opened it. He never let it out of sight. Naturally, everyone on the bus developed theories.
...
The bus passengers respected the strategy immediately. The next week, three more people appeared with briefcases. One contained lunch. One contained knitting supplies. One contained another smaller briefcase, which nobody dared question.`,
  ...
  {
    suspiciouskinddaStoryId: 'S8',
    suspiciouskinddaStoryNumber: 8,
    suspiciouskinddaStoryTag: 'Awkward',
    suspiciouskinddaStoryTitle: 'The Group Chat Silence',
    suspiciouskinddaStorySummary:
    ...
    suspiciouskinddaStoryBody: `Liam sent a message to the group chat: "Anyone want to grab pizza tonight?" The message was seen by four people. Nobody replied.
...
The story was true. The silence was still rude, but not a conspiracy. Liam forgave them, though he created a new group chat called "Pizza Witness Protection Program" and added everyone except the pizza place.`,
  ...
  {
    suspiciouskinddaStoryId: 'S9',
    suspiciouskinddaStoryNumber: 9,
    suspiciouskinddaStoryTag: 'Strange',
    suspiciouskinddaStoryTitle: 'The Woman Who Bought One Spoon Every Friday',
    suspiciouskinddaStorySummary:
      'Every Friday she visited the same store and bought exactly one spoon. Not a set. Just one spoon.',
    suspiciouskinddaStoryBody: `Every Friday evening, a woman visited the same home goods store and bought exactly one spoon. Not a set. Not a fork. Not a knife. One spoon. She paid in cash, thanked the cashier, and left.
...
The store staff accepted this completely. By the end of the year, they had started recommending spoons based on mood. One cashier became known as the best spoon consultant in the neighborhood.`,
  ...
  {
    suspiciouskinddaStoryId: 'S10',
    suspiciouskinddaStoryNumber: 10,
    suspiciouskinddaStoryTag: 'Office',
    suspiciouskinddaStoryTitle: 'The Suspiciously Clean Desk',
    suspiciouskinddaStorySummary:
      'Mark\'s desk was always chaos. Monday morning it was perfectly clean. People panicked.',
    suspiciouskinddaStoryBody: `Everyone knew Mark's desk was chaos. Papers, cables, sticky notes, snack wrappers, three mugs, and a rubber duck wearing sunglasses lived there permanently. So when the office arrived Monday morning and found Mark's desk perfectly clean, people panicked.
...
Mark was relieved. The office was relieved. The duck returned to its sunglasses position by lunchtime. However, Mark kept one label: "Important Chaos." It felt accurate.`,
  ...
  {
    suspiciouskinddaStoryId: 'S11',
    suspiciouskinddaStoryNumber: 11,
    suspiciouskinddaStoryTag: 'Sweet',
    suspiciouskinddaStoryTitle: 'The Birthday Cake Alibi',
    suspiciouskinddaStorySummary:
    ...
    suspiciouskinddaStoryBody: `A birthday cake disappeared from the office fridge two hours before the surprise party. The cake had been decorated with blue frosting and tiny stars. Everyone denied touching it, but someone had frosting on their finger.
...
The party happened successfully, but Tyler was banned from writing dramatic notes near desserts.`,
  ...
  {
    suspiciouskinddaStoryId: 'S12',
    suspiciouskinddaStoryNumber: 12,
    suspiciouskinddaStoryTag: 'Cute',
    suspiciouskinddaStoryTitle: 'The Plant That Got Fan Mail',
    suspiciouskinddaStorySummary:
      'An office plant named Gregory began receiving sticky notes. Then someone wrote, "Meet me by the window after lunch."',
    suspiciouskinddaStoryBody: `A small office plant named Gregory began receiving sticky notes. At first, they were simple: "Nice leaves." Then they became more emotional: "You are doing your best." Eventually, someone wrote, "Gregory understands me."
...
Gregory recovered beautifully. He also received Employee of the Month, which caused mild resentment among actual employees.`,
  ...
  {
    suspiciouskinddaStoryId: 'S13',
    suspiciouskinddaStoryNumber: 13,
    suspiciouskinddaStoryTag: 'Coincidence',
    suspiciouskinddaStoryTitle: 'The Bus Stop Conspiracy',
    suspiciouskinddaStorySummary:
      'For three days, Daniel saw the same woman reading the same page of the same book. She never turned the page.',
    suspiciouskinddaStoryBody: `For three days in a row, Daniel arrived at the bus stop and saw the same woman reading the same page of the same book. She never turned the page. She never looked up. She simply stood there, reading page 47.
...
The next Monday, she was reading page 48. Daniel did not ask questions.`,
  ...
  {
    suspiciouskinddaStoryId: 'S14',
    suspiciouskinddaStoryNumber: 14,
    suspiciouskinddaStoryTag: 'Digital',
    suspiciouskinddaStoryTitle: 'The Cat Who Sent an Email',
    suspiciouskinddaStorySummary:
      'At 2:03 AM, Martin\'s boss received an email from his account containing only "hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh."',
    suspiciouskinddaStoryBody: `At 2:03 AM, Martin's boss received an email from Martin's account. The message contained only: "hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh." It was followed by one attached image of a ceiling fan.
...
The cat was not punished. In fact, Martin changed his laptop password. The cat responded by sitting on the closed laptop for two hours, suggesting disagreement with the new security policy.`,
  ...
  {
    suspiciouskinddaStoryId: 'S15',
    suspiciouskinddaStoryNumber: 15,
    suspiciouskinddaStoryTag: 'Odd',
    suspiciouskinddaStoryTitle: 'The Suspicious Lemon',
    suspiciouskinddaStorySummary:
      'A single lemon appeared on the hotel front desk every morning for a week. Nobody placed it there. Nobody removed it.',
    suspiciouskinddaStoryBody: `A single lemon appeared on the front desk of a hotel every morning for a week. Nobody placed it there. Nobody removed it during the day. It simply existed, bright yellow and unexplained.
...
The manager allowed Gerald to remain as unofficial lobby mascot. Reviews later praised the hotel's "unique citrus hospitality."`,
  ...
  {
    suspiciouskinddaStoryId: 'S16',
    suspiciouskinddaStoryNumber: 16,
    suspiciouskinddaStoryTag: 'Clever',
    suspiciouskinddaStoryTitle: 'The Notebook Full of Fake Passwords',
    suspiciouskinddaStorySummary:
      'Anna found her friend\'s notebook open to a page titled "Important Passwords." The passwords were all suspiciously strange.',
    suspiciouskinddaStoryBody: `During a study session, Anna noticed her friend's notebook lying open. One page contained a list titled "Important Passwords." This was alarming, because writing passwords in a notebook is already risky. But the passwords were even stranger.
...
The notebook remained on the desk. A new fake password was added: "RoommateConfession2024."`,
  ...
  {
    suspiciouskinddaStoryId: 'S17',
    suspiciouskinddaStoryNumber: 17,
    suspiciouskinddaStoryTag: 'Absurd',
    suspiciouskinddaStoryTitle: 'The Man Who Clapped for the Microwave',
    suspiciouskinddaStorySummary:
      'Alex clapped once whenever the microwave finished heating food. Not twice. Just one sharp clap.',
    suspiciouskinddaStoryBody: `In a shared apartment, everyone noticed that Alex clapped once whenever the microwave finished heating food. Not twice. Not applause. Just one sharp clap.
...
Still, after learning this, everyone started clapping for the microwave. Not because they believed it helped, but because nobody wanted to risk disrespecting the machine.`,
  ...
  {
    suspiciouskinddaStoryId: 'S18',
    suspiciouskinddaStoryNumber: 18,
    suspiciouskinddaStoryTag: 'Rainy',
    suspiciouskinddaStoryTitle: 'The Umbrella That Was Too Popular',
    suspiciouskinddaStorySummary:
      'A black umbrella appeared in the office entrance. By Thursday, at least seven people claimed it was theirs.',
    suspiciouskinddaStoryBody: `A black umbrella appeared in the office entrance during a rainy week. It had no name tag, no special design, and no obvious owner. By Thursday, at least seven people claimed it was theirs.
...
The office returned it, disappointed. For one glorious week, the umbrella had united them through shared false confidence.`,
  ...
  {
    suspiciouskinddaStoryId: 'S19',
    suspiciouskinddaStoryNumber: 19,
    suspiciouskinddaStoryTag: 'Secret',
    suspiciouskinddaStoryTitle: 'The Suspiciously Loud Whisper',
    suspiciouskinddaStorySummary:
      'Priya and Tom kept whispering in the break room. Everyone heard phrases like "hide it before Friday."',
    suspiciouskinddaStoryBody: `Two coworkers, Priya and Tom, kept whispering in the break room. Unfortunately, they were terrible at whispering. Everyone heard phrases like "don't tell anyone," "hide it before Friday," and "make sure the box is sealed."
...
The herb garden became popular immediately. The office also created a rule: no whispering about basil unless everyone is invited.`,
  ...
  {
    suspiciouskinddaStoryId: 'S20',
    suspiciouskinddaStoryNumber: 20,
    suspiciouskinddaStoryTag: 'Spooky',
    suspiciouskinddaStoryTitle: 'The Chair That Moved Overnight',
    suspiciouskinddaStorySummary:
      'Every morning the meeting room chair was turned toward the window. The cleaning team said they did not move it.',
    suspiciouskinddaStoryBody: `Every morning, the chair in the meeting room was slightly turned toward the window. The cleaning team said they did not move it. The office staff said they always pushed chairs under the table. Yet every morning, the same chair faced the window like it was waiting for someone.
...
export const suspiciouskinddaIdeasStories: SuspiciouskinddaIdeasStory[] =
  suspiciouskinddaIdeasRawStories.map((suspiciouskinddaStory, suspiciouskinddaIndex) => ({
    ...suspiciouskinddaStory,
    suspiciouskinddaStoryAccent:
      suspiciouskinddaIdeasPickAccent(suspiciouskinddaIndex),
  }));
