export type NoteSuspStoryAccent = {
  color: string;
  background: string;
  border: string;
};

export type NoteSuspStory = {
  storyId: string;
  storyNumber: number;
  tag: string;
  title: string;
  summary: string;
  body: string;
  accent: NoteSuspStoryAccent;
};

export const noteSuspStoryAccents: NoteSuspStoryAccent[] =
  [
    {
      color: '#2EB3FF',
...
const noteSuspPickAccent = (
  index: number,
): NoteSuspStoryAccent =>
  noteSuspStoryAccents[
    index % noteSuspStoryAccents.length
  ];

const noteSuspRawStories: Omit<
  NoteSuspStory,
  'accent'
>[] = [
  {
...
export const noteSuspStories: NoteSuspStory[] =
  noteSuspRawStories.map((story, index) => ({
    ...story,
    accent:
      noteSuspPickAccent(index),
  }));
