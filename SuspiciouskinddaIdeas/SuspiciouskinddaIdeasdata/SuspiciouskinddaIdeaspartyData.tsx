export type SuspiciouskinddaIdeasPartyCategoryId =
  | 'caught_red_handed'
  | 'family_drama'
  | 'awkward_stranger'
  | 'online_crime'
...
export type SuspiciouskinddaIdeasPartyCategory = {
  suspiciouskinddaCategoryId: SuspiciouskinddaIdeasPartyCategoryId;
  suspiciouskinddaCategoryLabel: string;
  suspiciouskinddaCategoryColor: string;
  suspiciouskinddaCategoryTextColor: string;
  suspiciouskinddaSituations: string[];
};

export const suspiciouskinddaIdeasPartyCategories: SuspiciouskinddaIdeasPartyCategory[] =
  [
    {
      suspiciouskinddaCategoryId: 'caught_red_handed',
      suspiciouskinddaCategoryLabel: 'Caught Red-Handed',
      suspiciouskinddaCategoryColor: '#FF6B7A',
      suspiciouskinddaCategoryTextColor: '#1A2347',
      suspiciouskinddaSituations: [
    ...
    {
      suspiciouskinddaCategoryId: 'family_drama',
      suspiciouskinddaCategoryLabel: 'Family Drama',
      suspiciouskinddaCategoryColor: '#F7C948',
      suspiciouskinddaCategoryTextColor: '#1A2347',
      suspiciouskinddaSituations: [
    ...
    {
      suspiciouskinddaCategoryId: 'awkward_stranger',
      suspiciouskinddaCategoryLabel: 'Awkward Stranger',
      suspiciouskinddaCategoryColor: '#5BC4FF',
      suspiciouskinddaCategoryTextColor: '#1A2347',
      suspiciouskinddaSituations: [
    ...
    {
      suspiciouskinddaCategoryId: 'online_crime',
      suspiciouskinddaCategoryLabel: 'Online Crime',
      suspiciouskinddaCategoryColor: '#A06BFF',
      suspiciouskinddaCategoryTextColor: '#FFFFFF',
      suspiciouskinddaSituations: [
    ...
    {
      suspiciouskinddaCategoryId: 'pet_suspect',
      suspiciouskinddaCategoryLabel: 'Pet Suspect',
      suspiciouskinddaCategoryColor: '#4ADE80',
      suspiciouskinddaCategoryTextColor: '#1A2347',
      suspiciouskinddaSituations: [
    ...
    {
      suspiciouskinddaCategoryId: 'workplace_spy',
      suspiciouskinddaCategoryLabel: 'Workplace Spy',
      suspiciouskinddaCategoryColor: '#FF8A3D',
      suspiciouskinddaCategoryTextColor: '#1A2347',
      suspiciouskinddaSituations: [
